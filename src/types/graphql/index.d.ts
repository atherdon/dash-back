...
export type MutationPostBrandArgs = {
  brand: ParamsBrand;
};
...
export type BrandResolvers<ContextType = any, ParentType extends ResolversParentTypes['Brand'] = ResolversParentTypes['Brand']> = {
  ...
  avgTimeStory?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  avgAllTimeStory?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  postBrand?: Resolver<ResolversTypes['Response'], ParentType, ContextType, RequireFields<MutationPostBrandArgs, 'brand'>>;
};
